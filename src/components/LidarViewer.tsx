...
export class LidarViewer extends React.Component<
  LidarViewerProps,
  {
    hoveredPoint: {
      distance: number;
...
> {
  ...
  componentWillUnmount() {
    ...
    if (this.renderer) {
      ...
      if (
        ...
        this.renderer.domElement.parentElement === this.mountRef.current
      ) {
  ...
  componentDidUpdate(prevProps: LidarViewerProps) {
    ...
    if (
      prevProps.points3D !== this.props.points3D ||
      prevProps.update3DTrigger !== this.props.update3DTrigger
    ) {
      this.update3DPoints();
  ...
  private initThreeJS() {
    ...
    this.geometry2D.setAttribute(
      "color",
      new THREE.BufferAttribute(colors2D, 3),
    );
  ...
  private initSlamCloud() {
    ...
    this.slamGeometry.setAttribute(
      "position",
  ...
  private updateSlamPoints() {
    ...
    const positions = this.slamGeometry.attributes.position
            ...
            <div className="space-y-0.5">
              <div className="flex justify-between gap-4">
                ...
                <span className="text-white font-semibold">
                  {this.state.hoveredPoint.distance.toFixed(3)} m
                </span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-gray-400">Angle:</span>
                <span className="text-white font-semibold">
                  {this.state.hoveredPoint.angle.toFixed(1)}°
                </span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-gray-400">X:</span>
                <span className="text-white">
                  {this.state.hoveredPoint.x.toFixed(3)} m
                </span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-gray-400">Z:</span>
                <span className="text-white">
                  {this.state.hoveredPoint.z.toFixed(3)} m
                </span>
              </div>
            </div>
          </div>
