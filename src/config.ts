...
export function getBaudRateCommand(baudRate: number): Buffer {
    let mode = 2; // Default 115200
    if (baudRate === 3000000) mode = 0;
    else if (baudRate === 921600) mode = 1;
    else if (baudRate === 115200) mode = 2;
    else if (baudRate === 57600) mode = 3;
