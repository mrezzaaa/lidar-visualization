...
exports.interpolate = exports.checkSum = exports.LidarResponse = exports.LidarError3D = exports.lidartablez = exports.lidartabley = exports.lidartablex = exports.lidarPixelRealSize = exports.lidarRealImageSize = exports.lidarAngleCamera = exports.LidarSpec = exports.LidarError2D = exports.getBaudRateCommand = exports.Command = void 0;
exports.Command = {
    // 5A 77 FF 02 00 [CMD] [00] [CS]
    ...
    sensitivity: Buffer.from([0x5A, 0x77, 0xFF, 0x02, 0x00, 0x11, 0x00, 0x13]),
    frequency: Buffer.from([0x5A, 0x77, 0xFF, 0x02, 0x00, 0x0F, 0x00, 0x0D]),
    pulse: Buffer.from([0x5a, 0x77, 0xff, 0x02, 0x00, 0x0C, 0x00, 0x0E]),
};
function getBaudRateCommand(baudRate) {
    let mode = 2; // Default 115200
    if (baudRate === 3000000)
        mode = 0;
        ...
        mode = 3;
    // Header1(5A) Header2(77) ID(FF) LenLSB(2) LenMSB(0) PayloadHeader(12) PayloadData(Mode) CheckSum
    // CS = 02 ^ 00 ^ 12 ^ Mode
    const cs = 0x02 ^ 0x00 ^ 0x12 ^ mode;
    return Buffer.from([0x5A, 0x77, 0xFF, 0x02, 0x00, 0x12, mode, cs]);
}
exports.getBaudRateCommand = getBaudRateCommand;
exports.LidarError2D = [
    16000,
    16001,
    16002,
    16003,
...
exports.lidarPixelRealSize = 0.02;
exports.lidartablex = Array(exports.LidarSpec.width * exports.LidarSpec.height).fill(0);
exports.lidartabley = Array(exports.LidarSpec.width * exports.LidarSpec.height).fill(0);
exports.lidartablez = Array(exports.LidarSpec.width * exports.LidarSpec.height).fill(0);
exports.LidarError3D = [4080, 4081, 4082, 4083, 4084, 4085, 4086, 4087, 4088, 4089];
exports.LidarResponse = {
...
function interpolate(xin, x0, y0, x1, y1) {
    if ((Math.abs(x1 - x0) < exports.LidarSpec.epsilon)) {
        return y0;
    }
    else {
